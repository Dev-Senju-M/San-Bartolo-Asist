        ...
        <Layout>
            ...
            <Tarjeta>
                <div className="flex items-center justify-between mb-4">
                    <p className="text-sm text-vino-oscuro/60">
                        Asigna manualmente el puntaje de Comisión de cada socio para este mes (0 a 20 puntos).
                    </p>
                    <span className="text-sm text-vino-oscuro/60 shrink-0 ml-4">
            {miembros.length} socio(s)
          </span>
                </div>
                ...
                <div className="flex items-center gap-3 mt-6">
                    <Boton variante="dorado" onClick={guardar} disabled={guardando || cargando || miembros.length === 0}>
